          ...
          <section className={styles.section1}>
            <div className={styles.projectsHeader}>
              ...
              <button
                ...
                className={filterType === "Pending" ? styles.active : ""}
              >
                Pending
              </button>
              ...
              <button
                ...
                className={filterType === "InProgress" ? styles.active : ""}
              >
                InProgress
              </button>
              ...
              <button
                ...
                className={filterType === "Completed" ? styles.active : ""}
              >
                Completed
              </button>
            </div>
              ...
              {filteredProjects.map((project) => (
                <Card key={project.id}>
                  <div className={styles.projectInfo}>
                    <div
                      className={`${styles.projectData} ${project.projectStatus === "completed" ? styles.completed : project.projectStatus === "Pending" ? styles.pending : styles.inProgress}`}
                    >
