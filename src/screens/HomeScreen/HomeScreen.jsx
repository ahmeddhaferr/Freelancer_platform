              ...
              <div className={styles.recent}>
                ...
                {recentProjects.map((recentProject) => (
                  <div
                    ...
                    className={`${styles.recentItem} ${recentProjectOpened === recentProject.id && styles.active}`}
                  >
                    <div className={styles.recentHead}>
                      ...
                      <button
                        className={`${styles.arrowBtn} ${recentProjectOpened === recentProject.id && styles.active}`}
                        onClick={() =>
